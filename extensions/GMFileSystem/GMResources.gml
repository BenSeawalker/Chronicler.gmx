...
* @hidden     false
*/
return background_add(FS_copy_convert(argument0),argument1,argument2);
...
* @hidden     false
*/
return background_replace(argument0,FS_copy_convert(argument1),argument2,argument3);
...
return sprite_add(FS_copy_convert(argument0),argument1,argument2,argument3,argument4,argument5);
...
* @hidden     false
*/
return sprite_replace(argument0, FS_copy_convert(argument1),
